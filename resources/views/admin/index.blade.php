        ...
        <div class="row">
            <div class="col-md-6 col-xl-3 mb-3">
                <div class="card bg-primary text-white h-100">
                    <h4 class="card-title pt-3 pb-2 pb-md-0 fs-3 ps-3 m-0">{{ $countUsers }}</h4>
                    ...
                    <div class="card-footer py-3 d-flex">
                        <a class="nav-link" href="{{ route('admin.users')}}">Подробнее</a>
                        <span class="ms-auto">
            ...
            <div class="col-md-6 col-xl-3 mb-3">
                <div class="card bg-warning text-white h-100">
                    <h4 class="card-title pt-3 pb-2 pb-md-0 fs-3 ps-3 m-0">{{ $countRequests }}</h4>
                    <div class="card-body pb-2 pt-0 d-flex align-items-center">
                    ...
                    <div class="card-footer py-3 d-flex">
                        <a class="nav-link" href="{{ route('admin.requests')}}">Подробнее</a>
                        <span class="ms-auto">
                            <i class="fas fa-angle-right"></i>
                        </span>
                    </div>
            ...
            <div class="col-md-6 col-xl-3 mb-3">
                <div class="card bg-success text-white h-100">
                    <h4 class="card-title pt-3 pb-2 pb-md-0 fs-3 ps-3 m-0">{{ $countOtherRequests }}</h4>
                    <div class="card-body pb-2 pt-0 d-flex align-items-center">
                    ...
                    <div class="card-footer py-3 d-flex">
                        <a class="nav-link" href="{{ route('admin.requests', ['type' => 2])}}">Подробнее</a>
                        <span class="ms-auto">
                            <i class="fas fa-angle-right"></i>
                        </span>
                    </div>
            ...
            <div class="col-md-6 col-xl-3 mb-3">
                <div class="card bg-danger text-white h-100">
                    <h4 class="card-title pt-3 pb-2 pb-md-0 fs-3 ps-3 m-0">{{ $countComplaints }}</h4>
                    <div class="card-body pb-2 pt-0 d-flex align-items-center">
